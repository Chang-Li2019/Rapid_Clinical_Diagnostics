import os
path = "/Users/cli/Downloads/S14_patient"
os.chdir(path)
# Remove dict items
...
r_gene = {}
exp_gene = {}
with open('related_genes','r') as f4: # genelist from literature search
    r_gene_file = f4.readlines()
with open('final_genes','r') as f5: # genelist from literature search
